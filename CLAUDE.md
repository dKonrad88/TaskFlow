...
- ⚠️ **68 OCs "atrasadas"** (previsão < hoje) — são pedidos ANTIGOS (abril/etc.) com saldo residual ainda aberto no ERP; a disponível (est+OC) as inclui. É o dado do ERP; o Diego limpa lá se quiser. ⚠️ `_CP_CONS_25` (2025) e o resto seguem intactos. index.html 4,27→**4,30 MB**.
